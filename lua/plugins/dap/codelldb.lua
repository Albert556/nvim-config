...
local cmd = "/Users/albertguo/.config/nvim/extensions/codelldb/extension/adapter/codelldb"

-- if vim.fn.has("win32") == 1 then
--     cmd = [[ ~\AppData\Local\nvim\extensions\codelldb\extension\adapter\codelldb ]]
-- else
--     cmd = [[ ~/.config/nvim/extensions/codelldb/extension/adapter/codelldb ]]
-- end
